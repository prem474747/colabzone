  ...
  return (
    <motion.div initial="initial" animate='animate'>
        <motion.header variants={stagger}>
            <motion.div className="logo_wrapper" variants={header}>ColaB<span>zone</span></motion.div>
            <motion.div className="menu_container" variants={stagger}>
                ...
                <motion.span variants={header} className='menu' onClick={state ? HideDropDown : showDropDown} >
                    <span></span>
                    <span></span>
                    <span></span>
                </motion.span>
                </motion.div>
                <Dropdown className="dropdown" state = {state} header = {header}/>
        </motion.header>
        ...
        <motion.div className="content_wrapper" initial={{opacity:0,scale:0}} animate={{opacity:1,scale:1}} transition={{duration:0.3,ease:easeing}}>
            <motion.div className="left_content_wrapper">
                ...
                <motion.p variants={fadeInUp}>When, while lovely valley teems with vapor around means <br />meridian
                sun strikes the upper impenetrable.</motion.p>

                <motion.div className="btn_group" variants={stagger}>
                    <motion.div className="btn btn_primary" variants={btnGroup} whileHover={{scale:1.05}} whileTap={{scale:1.5}}>Hire Me
                        <IconContext.Provider value={{color:'#14da8f', size:"25px"}}>
                            <IoChevronForwardCircle/>
                        </IconContext.Provider>
                    </motion.div>
                    <motion.div className="btn btn_secondary" variants={btnGroup} whileHover={{scale:1.05}} whileTap={{scale:1.5}}>Live Chat</motion.div>
                </motion.div>
            ...
            <motion.div className="right_content_wrapper" initial={{x:200, opacity:0}} animate={{x:0,opacity:1}} transition={{duration:.5, delay:0.8}}>
